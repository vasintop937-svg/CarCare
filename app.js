...
(function(){ var s=document.getElementById('preload-status'); if(s) s.textContent='Тексты OK ✓'; })(); = [T['days-su'], T['days-mo'], T['days-tu'], T['days-we'], T['days-th'], T['days-fr'], T['days-sa']];
