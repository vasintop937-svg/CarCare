...
(function() {
  ...
  if (app) {
    app.innerHTML = '<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:16px">' +
      '<div style="font-family:Syne,sans-serif;font-size:28px;font-weight:800">Car<span style="color:#C8FF00">Diary</span></div>' +
      '<div style="color:#7A8099;font-size:14px">Загрузка...</div>' +
      '</div>';
  }
})();
